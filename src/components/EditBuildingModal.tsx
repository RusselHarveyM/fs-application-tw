    ...
    >
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 py-8 max-w-xl mx-auto">
            <div className="flex flex-col">
                <label htmlFor="buildingName" className="text-sm mb-2 text-center">Building Name:</label>
                <input
                type="text"
                id="buildingName"
                name="buildingName"
            ...
            <div className="flex flex-col">
                <label htmlFor="buildingCode" className="text-sm mb-2 text-center">Building Code:</label>
                <input
                type="text"
                id="buildingCode"
                name="buildingCode"
            ...
            <div className="flex flex-col">
                <label htmlFor="images" className="text-sm mb-2 text-center">Images:</label>
                <input
                type="file"
                id="images"
                name="images"
